  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Maxui - Empowering the world's freelancers. Your one-stop marketplace to discover, connect, and collaborate with professionals from diverse fields."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Maxui - Empowering the world's freelancers. Your one-stop marketplace to discover, connect, and collaborate with professionals from diverse fields.`}
            </Text>
            <Box
